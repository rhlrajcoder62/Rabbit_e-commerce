...
const GenderColleectionSection = () => {
  return (
        <section className='py-16 px-4 lg:px-0'>
          <div className='container mx-auto flex flex-col md:flex-row gap-8'>
            {/* Women's collection */}
            <div className='relative flex-1'>
              <img src={womensCollectionImage} alt="Women's Collection" className='w-full h-175 object-cover' />
            ...
            {/* Men's collection */}
              <div className='relative flex-1'>
              <img src={mensCollectionImage} alt="Men's Collection" className='w-full h-175 object-cover' />
              <div className='absolute bottom-8 left-8 bg-white bg-opacity-90 p-4'>
...
export default GenderColleectionSection
