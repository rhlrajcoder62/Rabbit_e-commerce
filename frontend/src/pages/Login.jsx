...
const Login = () => {
  ...
  return (
    <div className='flex'>
      ...
      <form className='w-full max-w-md bg-white p-8 rounded-lg border shadow-sm' action="#">
        ...
        <button type="submit" className='w-full bg-black text-white p-2 font-semibold rounded hover:bg-gray-800 transition'>
          Sign In
        </button>
      ...
      <div className="h-full flex flex-col justify-center items-center">
        <img src={login} alt="Login to Account" className='h-187.5 w-full object-cover'  />
        </div></div>
    </div>
  )
}
